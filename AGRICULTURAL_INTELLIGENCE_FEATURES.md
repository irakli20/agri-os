...
> Reference status: historical feature checklist. This file is useful for feature inventory, but its status markers are optimistic for real-farm readiness. Use `IMPLEMENTATION_ROADMAP.md` for the current implemented/partial/future status.
